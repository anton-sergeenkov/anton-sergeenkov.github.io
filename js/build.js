...
var arrReactjs = [
    ...
    ['react-js', 'main', 'structure',        'Структура'],
    ['react-js', 'main', 'jsx',              '<bg-menu-accent>1.</bg-menu-accent> JSX'],
    ['react-js', 'main', 'state',            '<bg-menu-accent>2.</bg-menu-accent> Состояние'],
    ['react-js', 'main', 'lifecycle',        '<bg-menu-accent>3.</bg-menu-accent> Жизненный цикл'],
    ['react-js', 'main', 'create-react-app', '<bg-menu-accent>4.</bg-menu-accent> Create React App'],

    [1, 'Компоненты'],
    ['react-js', 'components', 'components-and-props',  '<bg-menu-accent>1.</bg-menu-accent> Компоненты и пропсы'],
    ['react-js', 'components', 'lifting-state-up',      '<bg-menu-accent>2.</bg-menu-accent> Подъём состояния'],
    ['react-js', 'components', 'composition',           '<bg-menu-accent>3.</bg-menu-accent> Композиция'],

    [1, 'Обработка и вывод данных'],
    ['react-js', 'processing-data-output', 'css',                   '<bg-menu-accent>1.</bg-menu-accent> CSS'],
    ['react-js', 'processing-data-output', 'handling-events',       '<bg-menu-accent>2.</bg-menu-accent> Обработка событий'],
    ['react-js', 'processing-data-output', 'conditional-rendering', '<bg-menu-accent>3.</bg-menu-accent> Условный рендеринг'],
    ['react-js', 'processing-data-output', 'lists-and-keys',        '<bg-menu-accent>4.</bg-menu-accent> Списки и ключи'],
    ['react-js', 'processing-data-output', 'forms',                 '<bg-menu-accent>5.</bg-menu-accent> Формы'],
...
var arrGit = [
    ...
    [1, 'GitHub'],
    ['git', 'github', 'terminal-connect', '<bg-menu-accent>$</bg-menu-accent> Connect SSH'],
...
var arrVuejs = [
    ...
    ['vue-js', 'main', 'structure-code',  '<bg-menu-accent>&lt;/&gt;</bg-menu-accent> Пример кода vue-cli'],
    ['vue-js', 'main', 'instance-vue',    '<bg-menu-accent>&lt;/&gt;</bg-menu-accent> Экземпляр Vue'],
    ...
    ['vue-js', 'vue-router', 'path-static',          '<bg-menu-accent>1.</bg-menu-accent> Статический путь'],
    ['vue-js', 'vue-router', 'path-dynamic',         '<bg-menu-accent>2.</bg-menu-accent> Динамический путь'],
    ['vue-js', 'vue-router', 'path-comparison',      '<bg-menu-accent>3.</bg-menu-accent> Сопоставление путей'],
    ['vue-js', 'vue-router', 'navigation',           '<bg-menu-accent>4.</bg-menu-accent> Программная навигация'],
    ['vue-js', 'vue-router', 'passing-props',        '<bg-menu-accent>5.</bg-menu-accent> Входные параметры (props)'],
    ['vue-js', 'vue-router', 'navigation-guards',    '<bg-menu-accent>6.</bg-menu-accent> Навигационные хуки'],
    ['vue-js', 'vue-router', 'scroll-behavior',      '<bg-menu-accent>7.</bg-menu-accent> Поведение прокрутки страницы'],
    ['vue-js', 'vue-router', 'lazy-loading',         '<bg-menu-accent>8.</bg-menu-accent> Леннивая загрузка маршрутов'],
