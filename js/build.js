...
var arrReactjs = [
    ...
    ['react-js', 'components', 'components-and-props',  '<bg-menu>1.</bg-menu> Компоненты и пропсы'],
    ['react-js', 'components', 'lifting-state-up',      '<bg-menu>2.</bg-menu> Подъём состояния'],
    ['react-js', 'components', 'composition',           '<bg-menu>3.</bg-menu> Композиция'],

    [1, 'Обработка и вывод данных'],
    ['react-js', 'processing-data-output', 'css',                   '<bg-menu>1.</bg-menu> CSS'],
    ['react-js', 'processing-data-output', 'handling-events',       '<bg-menu>2.</bg-menu> Обработка событий'],
    ['react-js', 'processing-data-output', 'conditional-rendering', '<bg-menu>3.</bg-menu> Условный рендеринг'],
